import 'package:finalprojectmovies/src/actions/index.dart';
import 'package:finalprojectmovies/src/containers/pending_container.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  void _onNext(BuildContext context) {
    ...
    StoreProvider.of<AppState>(context)
        .dispatch(Login.start(email: _email.text, password: _password.text, onResult: onResult));
  }
